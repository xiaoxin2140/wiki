...
2. ✅ [完成高级KYC并获得Core 🆔](how-to-register-core-and-check-in.md#1-完成高级-kyc)
...
┌─────────────────────────────┐
│     2. 购买并配置云主机       │
│   最低 2核4G40G, Ubuntu 20.04 │
│   防火墙打开 30311/tcp+udp   │
└──────────┬──────────────────┘
           ↓
┌─────────────────────────────┐
│   3. 下载节点包并启动节点     │
│   jouleverse-node-20260129  │
└──────────┬──────────────────┘
           ↓
     ┌─────┴─────┐
     ↓           ↓
...
> 💡 步骤 4-7 的详细操作请参考 → [入网后：申请Core 🆔 与 每月链上签到指南](how-to-register-core-and-check-in.md)
